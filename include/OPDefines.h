...
_OP_DEF(opexe_2, "bitwise-not", 1, 1, TST_INTEGER, OP_BITNOT)
_OP_DEF(opexe_2, "bitwise-and", 2, INF_ARG, TST_INTEGER, OP_BITAND)
_OP_DEF(opexe_2, "bitwise-or", 2, INF_ARG, TST_INTEGER, OP_BITOR)
_OP_DEF(opexe_2, "bitwise-eor", 2, INF_ARG, TST_INTEGER, OP_BITEOR)
_OP_DEF(opexe_2, "bitwise-shift-left", 2, INF_ARG, TST_INTEGER, OP_BITLSL)
_OP_DEF(opexe_2, "bitwise-shift-right", 2, INF_ARG, TST_INTEGER, OP_BITLSR)
_OP_DEF(opexe_2, "quotient", 1, INF_ARG, TST_INTEGER, OP_INTDIV)
_OP_DEF(opexe_2, "remainder", 2, 2, TST_INTEGER, OP_REM)
_OP_DEF(opexe_2, "modulo", 2, 2, TST_NUMBER, OP_MOD)
...
_OP_DEF(opexe_3, "cptr?", 1, 1, TST_ANY, OP_CPTRP)
